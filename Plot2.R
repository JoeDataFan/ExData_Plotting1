# Coursera Exploratory Data Analysis week 1 peer reviewed assignment plot2
# 10-29-2016
...
plot(data$index, data$Global_active_power,xlab = "" , ylab = "Global Active Power (kilowatts)", type = "l", xaxt = "n")
